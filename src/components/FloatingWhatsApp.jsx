...
const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      className="fixed z-50 bottom-5 right-5 bg-[#25D366] text-white w-14 h-14 rounded-full shadow-[0_10px_20px_rgba(37,211,102,0.4)] flex items-center justify-center transition-transform duration-300 hover:scale-105"
    >
